...
public class ImageUtils {
     ...
     * @throws IOException
     */
    public static byte[] image2ByteArray(BufferedImage image, String format) throws IOException {
     ...
     * @throws IOException
     */
    public static String image2Base64(BufferedImage image, String format) throws IOException {
        byte[] bytes = image2ByteArray(image, format);
